...
if __name__ == "__main__":
    ...
    printer.configure_options(delimiter_left="<", delimiter_right=">",
                              delimiter_left_color="red", delimiter_right_color="red", separator_back="-",
                              separator_front="-", separator_front_color="yellow", separator_back_color="blue",
                              delimiter_space=2)
    printer.test_configurations()

    printer.separate_line("back")
    printer.separate_line("front")

    printer.print(text="This is some text")
